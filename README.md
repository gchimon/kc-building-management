...
### תמונות רקע הירו
האתר כולל 4 תמונות רקע שונות להירו סקשן, כל אחת עם 3 גדלים:
- **Large**: למסכים רחבים (1200px+)
- **Medium**: לטאבלטים (768px-1199px)
- **Small**: למובייל (עד 767px)

### תמונות שירותים
כל שירות כולל תמונה ייחודית:
- **ניקיון**: תמונת שירותי ניקיון מקצועיים
- **גינון**: תמונת גינון וטיפוח נוף
- **הדברת מזיקים**: תמונות עם 3 גדלים שונים
- **הדברת יונים**: תמונת שירות ייעודי
- **ליטוש**: תמונת שירותי ליטוש
- **שיפוץ**: תמונות עם 3 גדלים שונים
...
- **שעות פעילות**: 24/7 - מענה חירום זמין
